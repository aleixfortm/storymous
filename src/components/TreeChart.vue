...
<style scoped>
table{border-collapse: separate!important; border-spacing: 0!important; margin: auto; width: 100%; color: whitesmoke}
td{position: relative; vertical-align: top;padding:0px 0 40px 0;text-align: center; }

.extend_handle{position: absolute;left:50%;bottom:20px; width:30px;height: 30px;padding: 10px;transform: translate3d(-15px,0,0);cursor: pointer;}
...
.extend_handle:hover:before{border-color:#747474 #747474 transparent transparent;}
...
.node .person .avat{display: block;width:50px;height:auto;margin:auto;overflow:hidden; background:#ffffff00;border:1px solid #cccccc3a;box-sizing: border-box; border-radius: 500%;}
